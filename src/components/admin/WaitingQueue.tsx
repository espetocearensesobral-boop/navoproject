...
"Profissional a definir"}{""}
 ...
 className="w-9 h-9 rounded-[var(--admin-radius-md)] bg-status-error/10 text-status-error hover:bg-status-error/10 disabled:opacity-50 disabled:cursor-wait transition-colors"
