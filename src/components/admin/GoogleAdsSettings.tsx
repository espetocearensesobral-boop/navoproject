...
export const GoogleAdsSettings: React.FC<GoogleAdsSettingsProps> = ({
 ...
 {CAMPAIGNS_DEMO_MODE && (
 <div
 className="rounded-[var(--admin-radius-md)] border border-status-info/30 bg-status-info/10 px-3 py-2 text-xs text-status-info"
 role="status"
 >
 ...
 onClick={() => void load()}
 disabled={loading}
 className="inline-flex min-h-9 shrink-0 items-center gap-1.5 rounded-[var(--admin-radius-lg)] border border-status-warning/30 px-3 text-xs font-bold text-status-warning hover:bg-status-warning/10 disabled:opacity-50"
 >
 <RefreshCw
 ...
 {!status?.configured && (
 <section className="rounded-[var(--admin-radius-lg)] border border-status-warning/30 bg-status-warning/10 p-4 sm:p-5">
 ...
 Callback esperado:{""}
 <code className="break-all text-status-warning">
 ...
 <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[var(--admin-radius-lg)] bg-status-info/10 text-status-info">
 ...
 <p className="rounded-[var(--admin-radius-lg)] bg-status-error/10 px-3 py-2 text-xs text-status-error">
 {connection.lastError}
 </p>
 )}
 ...
 disabled={busy}
 className="inline-flex min-h-9 items-center gap-1.5 rounded-[var(--admin-radius-lg)] bg-status-error/10 px-3 text-xs font-bold text-status-error transition-colors hover:bg-status-error/10 disabled:opacity-50"
 >
 ...
 <div className="rounded-[var(--admin-radius-lg)] bg-[var(--admin-surface)] p-4 sm:p-5">
 <div className="flex items-start gap-3">
 <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-[var(--admin-radius-md)] bg-status-info/10 text-status-info">
