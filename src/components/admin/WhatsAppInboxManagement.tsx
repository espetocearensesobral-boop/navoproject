...
export const WhatsAppInboxManagement: React.FC = () => {
 ...
 :"bg-[var(--admin-bg)] text-amber-500 hover:bg-status-warning/10"
 }`}
 >
 ...
 {isHuman ? (
 <span className="px-2 py-0.5 rounded-[var(--admin-radius-full)] text-[10px] font-bold bg-status-warning/10 text-amber-500 border border-status-warning/30">
 🔔 Atendimento Humano
 </span>
 ) : (
