...
"error",
 ...
 isPending
 ?"bg-status-warning/10 border-status-warning/30 text-status-warning shadow-sm"
 : operationalState.isLate
 ...
 >
 {isPending && (
 <div className="flex items-center justify-between text-xs font-bold text-status-warning mb-1.5 uppercase tracking-wider bg-status-warning/10 px-2 py-0.5 rounded-[var(--admin-radius-lg)] border border-status-warning/30">
...
"Atendimento"}
 ...
 {isPending && (
 <div className="pt-2 border-t border-status-warning/30 flex items-center justify-end gap-2 mt-2">
 <button
 type="button"
 onClick={() =>
 ...
 <div
 key={block.id}
 className="min-h-[72px] p-4 rounded-[var(--admin-radius-xl)] bg-status-error/10 border border-status-error/30 flex items-center justify-between text-sm text-status-error shadow-sm"
 >
 <div className="flex items-center gap-1.5 truncate">
 <Lock className="w-3 h-3 text-status-error shrink-0"/>
 ...
 className="text-xs text-status-error underline font-bold shrink-0 ml-1"
 >
 Desbloquear
 </button>
 </div>
 ...
 >
 {isPending && (
 <div className="flex items-center gap-1 text-xs font-bold text-status-warning uppercase tracking-wide">
 ...
 <div className="w-full bg-status-error/10 border border-status-error/30 p-2 rounded-[var(--admin-radius-lg)] flex items-center justify-between text-xs text-status-error">
 <div className="flex items-center space-x-1.5">
 <Lock className="w-3.5 h-3.5 text-status-error"/>
 ...
 <button
 onClick={() => handleUnblock(block.id)}
 className="text-status-error hover:text-[var(--admin-text-main)] text-xs underline ml-2"
