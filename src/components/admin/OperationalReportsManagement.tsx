...
const MiniMetric: React.FC<{
 ...
 <span
 className={`w-8 h-8 rounded-[var(--admin-radius-md)] shrink-0 flex items-center justify-center ${tone ==="positive"?"text-status-success bg-status-success/10": tone ==="negative"?"text-status-error bg-status-error/10":"text-amber-500 bg-status-warning/10"}`}
 >
 <Icon className="w-4 h-4"/>
 </span>
