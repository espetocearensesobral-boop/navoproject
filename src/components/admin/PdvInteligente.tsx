        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          <div className="p-2.5 rounded-xl bg-surface-base border border-border-subtle flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0 truncate">
              <span className="text-[9px] text-content-muted font-bold uppercase tracking-wider block truncate">Faturamento Hoje</span>
              <span className="text-sm font-bold text-content-base font-mono num-tabular block truncate">R$ {totalRevenueToday.toFixed(2)}</span>
            </div>
          </div>
          ...
          <div className="p-2.5 rounded-xl bg-surface-base border border-border-subtle flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0 truncate">
              <span className="text-[9px] text-content-muted font-bold uppercase tracking-wider block truncate">Checkouts</span>
              <span className="text-sm font-bold text-content-base block truncate">{todaysSales.length} vendas</span>
            </div>
          </div>
          ...
          <div className="p-2.5 rounded-xl bg-surface-base border border-border-subtle flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0 truncate">
              <span className="text-[9px] text-content-muted font-bold uppercase tracking-wider block truncate">Pendentes</span>
              <span className="text-sm font-bold text-content-base block truncate">{pendingAppointments.length} horários</span>
            </div>
          </div>
          ...
          <div className="p-2.5 rounded-xl bg-surface-base border border-border-subtle flex items-center gap-2.5 min-w-0">
            ...
            <div className="min-w-0 truncate">
              <span className="text-[9px] text-content-muted font-bold uppercase tracking-wider block truncate">Produtos</span>
              <span className="text-sm font-bold text-content-base block truncate">{products.length} itens</span>
            </div>
          </div>
        </div>
      </div>
