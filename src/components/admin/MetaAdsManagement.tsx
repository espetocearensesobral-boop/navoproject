  ...
  return (
    <div className="space-y-4 min-w-0">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-5">
        <MetricCard icon={BarChart3} label="Investido" value={formatCents(totals.spendCents, connection?.currency || 'BRL')} helper="Total sincronizado" tone="finance-negative" />
        <MetricCard icon={Users} label="Leads" value={formatCompactNumber(totals.leads)} helper="Ações de lead retornadas" tone="text-status-success" />
