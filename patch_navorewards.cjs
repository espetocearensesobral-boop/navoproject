const fs = require('fs');
let code = fs.readFileSync('src/components/admin/NavoRewardsAdmin.tsx', 'utf8');
...
fs.writeFileSync('src/components/admin/NavoRewardsAdmin.tsx', code);
console.log("Patched NavoRewardsAdmin");
